+++
title = 'Ageu 2:1-9 - A Obediência Exige Determinação e Força'
subtitle = "Mesmo diante de recursos limitados e aparências modestas, a presença do Senhor garante a glória futura da Sua casa."
date = '2023-08-24'
draft = false
categorias = ['Sermões', 'Ageu', 'Antigo Testamento']
tags = ['Ageu', 'Antigo Testamento', 'Encorajamento', 'Presença de Deus', 'Obediência']
image = "/images/posts/ageu-2-1-9-a-obediencia-exige-determinacao.webp"
+++
...
4. Você está ciente de que o arrependimento é uma questão do coração? Você entende que o arrependimento genuíno requer uma mudança no coração e que o comportamento sempre seguirá o coração?

5. Você já passou algum tempo na presença de Deus hoje? Podemos conhecer a Deus através de Sua Palavra e oração. Você já O buscou por esses caminhos hoje?
